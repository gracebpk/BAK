...
Public Class FrmProveedores
    ...
    Public Sub ARMAR_DATAGRIDVIEW()
        DataGridView1.Columns(0).HeaderText = "ID PROVEEDOR"
        DataGridView1.Columns(1).HeaderText = "NOMBRE DE PROVEEDOR"
    ...
    Private Sub CARGAR()
        ...
        Try
            ...
            DS_U.Clear()
            DA_U.Fill(DS_U, "PROVEEDOR")
            DataGridView1.DataSource = DS_U.Tables("PROVEEDOR")
        Catch oExcep As SqlException
            MessageBox.Show("Error: " & ControlChars.CrLf & oExcep.Message & ControlChars.CrLf & oExcep.Server)
        Finally
            If ConeccionBD.CONECCION.State = ConnectionState.Open Then
    ...
    Private Sub BtnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If R = vbYes Then
            ...
            ELIMINA_SQL = "DELETE FROM DBO.PROVEEDOR WHERE IDPROVEEDOR = '" & P01 & "'"
